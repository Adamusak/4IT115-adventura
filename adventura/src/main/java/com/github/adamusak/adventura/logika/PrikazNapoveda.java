 ...
 * 
 * @author Jarmila Pavlickova, Luboš Pavlíček, Adam Novak
...
class PrikazNapoveda implements IPrikaz {
	 ...
	 * 
	 * @param platnePrikazy
	 *            seznam příkazů, které je možné ve hře použít, aby je nápověda
	 *            mohla zobrazit uživateli.
	 */
	...
	/**
	 * Vrací základní nápovědu po zadání příkazu "napoveda". Nyní se vypisuje vcelku
	 * primitivní zpráva a seznam dostupných příkazů.
	 * 
