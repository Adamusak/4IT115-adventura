 ...
 * 
 * @author Jarmila Pavlickova, Luboš Pavlíček, Alena Buchalcevova, Adam Novak
...
public class PrikazSeber implements IPrikaz {
	...
	/**
	 * Provádí příkaz "seber". V aktuální místnosti hledá věc, která je předána jako
	 * parametr
	 * 
	 *
	 * @param parametry
	 *            - jako parametr obsahuje jméno věci, která se má sebrat.
