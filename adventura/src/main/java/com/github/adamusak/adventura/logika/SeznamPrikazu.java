...
public class SeznamPrikazu {
	 ...
	 *
	 * @param prikaz
	 *            Instance třídy implementující rozhraní IPrikaz
	 */
	...
	/**
	 * Vrací odkaz na instanci třídy implementující rozhraní IPrikaz, která provádí
	 * příkaz uvedený jako parametr.
	 *
	 * @param retezec
	 *            klíčové slovo příkazu, který chce hráč zavolat
	 ...
	 *
	 * @param retezec
	 *            Řetězec, který se má otestovat, zda je přípustný příkaz
